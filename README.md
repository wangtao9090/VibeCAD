...
> https://github.com/wangtao9090/VibeCAD. Use tag `v0.10.1`, clone it into a persistent
...
The release asset `vibecad-agent-skill-0.10.1.zip` contains exactly one top-level
...
The 0.10.1 release contract verifies the MCP protocol, Skill package structure, FCStd/STEP and
