...
- 它以 **FreeCAD 1.1.0 + OCCT** 为几何内核，不要求用户打开 FreeCAD GUI。
...
当前 0.4.0 尚未实现上述 Task Service、Reasoning Backend、ModelProgram、任务级 candidate 或 Agent eval，文档和产品不得把目标能力描述成现有功能。
