...
def test_list_parameters_whitelist_only():
    ...
    doc = _FakeDoc(
        [
            ...
            _FakeObj("Cone", "Part::Cone", Radius1=6.0, Radius2=2.0, Height=15.0),
            _FakeObj("Sphere", "Part::Sphere", Radius=8.0),
            _FakeObj("Torus", "Part::Torus", Radius1=10.0, Radius2=3.0),
    ...
    assert out == {
        "Part1": {
            ...
            "Cone": {"base_radius": 6.0, "top_radius": 2.0, "height": 15.0},
            "Sphere": {"radius": 8.0},
